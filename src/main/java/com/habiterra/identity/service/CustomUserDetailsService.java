...
public class CustomUserDetailsService implements UserDetailsService {
    private final UtilisateurRepository users; private final IdentifierService identifiers;
    public CustomUserDetailsService(UtilisateurRepository users,IdentifierService identifiers){this.users=users;this.identifiers=identifiers;}
